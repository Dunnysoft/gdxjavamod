...
package com.dunnysoft.ogg.jogg;
...
public class Buffer{
  ...
  public void write(int value, int bits){
    ...
    if(bits>=8){
      buffer[ptr+1]=(byte)((value>>(8-endbit))&0xFF);
      if(bits>=16){
        buffer[ptr+2]=(byte)((value>>(16-endbit))&0xFF);
        if(bits>=24){
          buffer[ptr+3]=(byte)((value>>(24-endbit))&0xFF);
          if(bits>=32){
            if(endbit>0)
              buffer[ptr+4]=(byte)((value>>(32-endbit))&0xFF);
            else
              buffer[ptr+4]=0;
          }
        }
