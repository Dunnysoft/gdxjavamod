 ...
 *----------------------------------------------------------------------
 */
package com.dunnysoft.gdxjavamod.mixer;
...
public abstract class BasicMixer extends Mixer
{
	...
	/**
	 * @return
	 * @see com.dunnysoft.gdxjavamod.mixer.Mixer#isPaused()
	 */
	@Override
	...
	/**
	 * @return
	 * @see com.dunnysoft.gdxjavamod.mixer.Mixer#isPausing()
	 */
	@Override
	...
	/**
	 * @return
	 * @see com.dunnysoft.gdxjavamod.mixer.Mixer#isStopped()
	 */
	@Override
	...
	/**
	 * @return
	 * @see com.dunnysoft.gdxjavamod.mixer.Mixer#isStopping()
	 */
	@Override
	...
	/**
	 * @return
	 * @see com.dunnysoft.gdxjavamod.mixer.Mixer#isNotPausingNorPaused()
	 */
	@Override
	...
	/**
	 * @return
	 * @see com.dunnysoft.gdxjavamod.mixer.Mixer#isNotStoppingNorStopped()
	 */
	@Override
	...
	/**
	 * @return
	 * @see com.dunnysoft.gdxjavamod.mixer.Mixer#isPlaying()
	 */
	@Override
	...
	/**
	 * @return
	 * @see com.dunnysoft.gdxjavamod.mixer.Mixer#isFinished()
	 */
	@Override
	...
	/**
	 * @param milliseconds
	 * @see com.dunnysoft.gdxjavamod.mixer.Mixer#setMillisecondPosition(long)
	 */
	@Override
	...
	/**
	 * @param milliseconds
	 * @see com.dunnysoft.gdxjavamod.mixer.Mixer#setStopMillisecondPosition(long)
	 */
	@Override
