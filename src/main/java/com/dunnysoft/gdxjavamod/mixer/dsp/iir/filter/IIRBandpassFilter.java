 ...
 * 
 */
package com.dunnysoft.gdxjavamod.mixer.dsp.iir.filter;
...
public class IIRBandpassFilter extends IIRFilterBase
{
	 ...
	 * @param frequency
	 * @param parameter
	 * @see com.dunnysoft.gdxjavamod.mixer.dsp.iir.filter.IIRFilterBase#initialize(int, int, int, float)
	 * @since 09.01.2012
	 */
	@Override
	 ...
	 * @param kIndex
	 * @return
	 * @see com.dunnysoft.gdxjavamod.mixer.dsp.iir.filter.IIRFilterBase#performFilterCalculation(float, int, int, int, int)
	 * @since 12.01.2012
	 */
	@Override
