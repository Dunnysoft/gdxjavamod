 ...
 *----------------------------------------------------------------------
 */
package com.dunnysoft.gdxjavamod.mixer.dsp.iir;

import javax.sound.sampled.AudioFormat;

import com.dunnysoft.gdxjavamod.mixer.dsp.DSPEffekt;
import com.dunnysoft.gdxjavamod.mixer.dsp.iir.filter.IIRBandpassFilter;
import com.dunnysoft.gdxjavamod.mixer.dsp.iir.filter.IIRFilter;
import com.dunnysoft.gdxjavamod.mixer.dsp.iir.filter.IIRFilterBase;
...
public class GraphicEQ implements DSPEffekt
{
	...
	/**
	 * @param audioFormat
	 * @see com.dunnysoft.gdxjavamod.mixer.dsp.DSPEffekt#initialize(javax.sound.sampled.AudioFormat)
	 * @since 09.01.2012
	 */
	...
	/**
	 * @param active
	 * @see com.dunnysoft.gdxjavamod.mixer.dsp.DSPEffekt#setIsActive(boolean)
	 */
	...
	/**
	 * @return
	 * @see com.dunnysoft.gdxjavamod.mixer.dsp.DSPEffekt#isActive()
	 */
	 ...
	 * @param start
	 * @param length
	 * @see com.dunnysoft.gdxjavamod.mixer.dsp.DSPEffekt#doEffekt(float[], int, int)
	 * @since 09.01.2012
	 */
