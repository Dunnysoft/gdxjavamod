 ...
 *----------------------------------------------------------------------
 */
package com.dunnysoft.gdxjavamod.multimedia.mp3.id3;


import java.io.FileNotFoundException;
import java.io.IOException;

import com.dunnysoft.gdxjavamod.io.RandomAccessInputStream;
import com.dunnysoft.gdxjavamod.multimedia.mp3.id3.exceptions.NoMPEGFramesException;
