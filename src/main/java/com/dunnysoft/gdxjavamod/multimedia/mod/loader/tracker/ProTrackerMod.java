...
import com.dunnysoft.gdxjavamod.multimedia.mod.mixer.ProTrackerMixer;
...
public class ProTrackerMod extends Module
{
	 ...
	 * @param sampleRate
	 * @return
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.loader.Module#getModMixer(int)
	 */
	@Override
	 ...
	 * @param inputStream
	 * @return
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.loader.Module#loadModFile(java.io.DataInputStream)
	 */
	@Override
