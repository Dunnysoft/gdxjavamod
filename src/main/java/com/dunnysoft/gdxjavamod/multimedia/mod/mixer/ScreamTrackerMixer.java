 ...
 *----------------------------------------------------------------------
 */
package com.dunnysoft.gdxjavamod.multimedia.mod.mixer;

import com.dunnysoft.gdxjavamod.multimedia.mod.ModConstants;
import com.dunnysoft.gdxjavamod.multimedia.mod.loader.Module;
import com.dunnysoft.gdxjavamod.multimedia.mod.loader.instrument.Envelope;
import com.dunnysoft.gdxjavamod.multimedia.mod.loader.instrument.Instrument;
import com.dunnysoft.gdxjavamod.multimedia.mod.loader.instrument.Sample;
import com.dunnysoft.gdxjavamod.multimedia.mod.loader.pattern.PatternElement;
import com.dunnysoft.gdxjavamod.multimedia.mod.midi.MidiMacros;
...
public class ScreamTrackerMixer extends BasicModMixer
{
	 ...
	 * @param channel
	 * @param aktMemo
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#initializeMixer(int, com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer.ChannelMemory)
	 */
	@Override
	...
	/**
	 * @param aktMemo
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#doRowEffects(com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer.ChannelMemory)
	 */
	@Override
...
//								break;
			...
			case 0x16 :			// Set Global Volume
				if (aktMemo.effektParam<=0x80)
				{
					...
					/*if ((mod.getModType()&ModConstants.MODTYPE_IT)==0)*/ globalVolume <<= 1;
				}
				break;
	 ...
	 * @param currentSample
	 * @param currentPeriod
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#doAutoVibratoEffekt(com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer.ChannelMemory, com.dunnysoft.gdxjavamod.multimedia.mod.loader.instrument.Sample)
	 */
	@Override
...
//		setNewPlayerTuningFor(aktMemo, newPeriod);
	...
	/**
	 * @param aktMemo
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#doTickEffekts(com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer.ChannelMemory)
	 */
	@Override
	...
	/**
	 * @param aktMemo
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#doVolumeColumnRowEffekt(com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer.ChannelMemory)
	 */
	@Override
...
//				}
	...
	/**
	 * @param aktMemo
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#doVolumeColumnTickEffekt(com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer.ChannelMemory)
	 */
	@Override
	 ...
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#isNoteDelayEffekt(com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer.ChannelMemory)
	 */
	@Override
	 ...
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#isPortaToNoteEffekt(com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer.ChannelMemory)
	 */
	@Override
	 ...
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#isSampleOffsetEffekt(com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer.ChannelMemory)
	 */
	@Override
	 ...
	 * @param aktMemo
	 * @return
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#isNNAEffekt(com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer.ChannelMemory)
	 */
	@Override
	 ...
	 * @param effektParam
	 * @return
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.mixer.BasicModMixer#getEffektOpMemory(int, int)
	 */
	@Override
