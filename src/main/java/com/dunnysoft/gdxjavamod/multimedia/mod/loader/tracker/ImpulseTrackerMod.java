...
public class ImpulseTrackerMod extends ScreamTrackerMod
{
	...
	/**
	 * @return
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.loader.tracker.ScreamTrackerMod#getFrequencyTable()
	 */
	@Override
	 ...
	 * @param channel
	 * @return
	 * @see com.dunnysoft.gdxjavamod.multimedia.mod.loader.tracker.ScreamTrackerMod#getChannelVolume(int)
	 */
	@Override
