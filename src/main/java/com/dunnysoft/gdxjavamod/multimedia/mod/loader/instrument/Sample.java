 ...
 *----------------------------------------------------------------------
 */
package com.dunnysoft.gdxjavamod.multimedia.mod.loader.instrument;

import com.dunnysoft.gdxjavamod.multimedia.mod.ModConstants;
import com.dunnysoft.gdxjavamod.multimedia.mod.mixer.interpolation.CubicSpline;
import com.dunnysoft.gdxjavamod.multimedia.mod.mixer.interpolation.WindowedFIR;
...
public class Sample
{
	...
	private void addInterpolationLookAheadDataLoop(final int startIndex, final int length, final int sourceIndex, final boolean isForward, final boolean isPingPong, final boolean forLoopEnd)
	{
		...
		for (int i=0; i<numSamples; i++)
		{
			...
			if (sampleR!=null) sampleR[destIndex] = sampleL[readPosition];
	...
	private void addInterpolationLookAheadData()
	{
		...
		for (int pos=0; pos<INTERPOLATION_LOOK_AHEAD; pos++)
		{
			...
			if (sampleR!=null) sampleL[pos] = sampleL[startSampleData];
