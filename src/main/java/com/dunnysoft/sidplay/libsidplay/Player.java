 ...
 *
 */
package com.dunnysoft.sidplay.libsidplay;

import static com.dunnysoft.sidplay.libsidplay.Config.PACKAGE_NAME;
import static com.dunnysoft.sidplay.libsidplay.Config.PACKAGE_VERSION;
import static com.dunnysoft.sidplay.libsidplay.Config.S_A_WHITE_EMAIL;
import static com.dunnysoft.sidplay.libsidplay.common.Event.event_phase_t.EVENT_CLOCK_PHI1;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.SID2_DEFAULT_OPTIMISATION;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.SID2_DEFAULT_POWER_ON_DELAY;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.SID2_DEFAULT_PRECISION;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.SID2_DEFAULT_SAMPLING_FREQ;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.SID2_MAX_OPTIMISATION;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.SID2_MAX_POWER_ON_DELAY;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.SID2_MAX_PRECISION;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_clock_t.SID2_CLOCK_CORRECT;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_clock_t.SID2_CLOCK_NTSC;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_clock_t.SID2_CLOCK_PAL;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_env_t.sid2_envBS;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_env_t.sid2_envPS;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_env_t.sid2_envR;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_model_t.SID2_MODEL_CORRECT;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_model_t.SID2_MOS6581;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_model_t.SID2_MOS8580;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_playback_t.sid2_left;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_playback_t.sid2_mono;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_playback_t.sid2_stereo;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_player_t.sid2_paused;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_player_t.sid2_playing;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_player_t.sid2_stopped;
import static com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_sample_t.SID2_LITTLE_SIGNED;
import static com.dunnysoft.sidplay.libsidplay.common.SIDEndian.endian_16;
import static com.dunnysoft.sidplay.libsidplay.common.SIDEndian.endian_16hi8;
import static com.dunnysoft.sidplay.libsidplay.common.SIDEndian.endian_little16;
import static com.dunnysoft.sidplay.libsidplay.common.mos6510.IOpCode.JMPi;
import static com.dunnysoft.sidplay.libsidplay.common.mos6510.IOpCode.JMPw;
import static com.dunnysoft.sidplay.libsidplay.common.mos6510.IOpCode.JSRw;
import static com.dunnysoft.sidplay.libsidplay.common.mos6510.IOpCode.LDAb;
import static com.dunnysoft.sidplay.libsidplay.common.mos6510.IOpCode.RTSn;
import static com.dunnysoft.sidplay.libsidplay.common.mos6510.IOpCode.STAa;
import static com.dunnysoft.sidplay.libsidplay.components.mos656x.MOS656X.mos656x_model_t.MOS6567R8;
import static com.dunnysoft.sidplay.libsidplay.components.mos656x.MOS656X.mos656x_model_t.MOS6569;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_CLOCK_ANY;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_CLOCK_NTSC;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_CLOCK_PAL;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_CLOCK_UNKNOWN;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_COMPATIBILITY_BASIC;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_COMPATIBILITY_PSID;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_COMPATIBILITY_R64;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_SIDMODEL_6581;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_SIDMODEL_8580;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_SIDMODEL_ANY;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_SIDMODEL_UNKNOWN;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_SPEED_CIA_1A;
import static com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune.SIDTUNE_SPEED_VBI;
import static com.dunnysoft.sidplay.libsidplay.mem.IBasic.BASIC;
import static com.dunnysoft.sidplay.libsidplay.mem.IChar.CHAR;
import static com.dunnysoft.sidplay.libsidplay.mem.IKernal.KERNAL;
import static com.dunnysoft.sidplay.libsidplay.mem.IPSIDDrv.PSIDDRV;
import static com.dunnysoft.sidplay.libsidplay.mem.IPowerOn.POWERON;
import com.dunnysoft.sidplay.libsidplay.common.C64Env;
import com.dunnysoft.sidplay.libsidplay.common.Event;
import com.dunnysoft.sidplay.libsidplay.common.EventScheduler;
import com.dunnysoft.sidplay.libsidplay.common.IEventContext;
import com.dunnysoft.sidplay.libsidplay.common.SIDBuilder;
import com.dunnysoft.sidplay.libsidplay.common.SIDEmu;
import com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_clock_t;
import com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_config_t;
import com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_env_t;
import com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_info_t;
import com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_model_t;
import com.dunnysoft.sidplay.libsidplay.common.ISID2Types.sid2_player_t;
import com.dunnysoft.sidplay.libsidplay.common.mos6510.C64Environment;
import com.dunnysoft.sidplay.libsidplay.common.mos6510.MOS6510;
import com.dunnysoft.sidplay.libsidplay.common.mos6510.SID6510;
import com.dunnysoft.sidplay.libsidplay.components.mos6526.C64CIA;
import com.dunnysoft.sidplay.libsidplay.components.mos6526.SID6526;
import com.dunnysoft.sidplay.libsidplay.components.mos656x.C64VIC;
import com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTune;
import com.dunnysoft.sidplay.libsidplay.components.sidtune.SidTuneInfo;
import com.dunnysoft.sidplay.libsidplay.components.xsid.C64XSID;
...
public class Player extends C64Env /* extends C64Environment */{
	...
	/**
	 * Makes the next sequence of notes available. For com.dunnysoft.sidplay.sidplay compatibility
