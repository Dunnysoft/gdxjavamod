 ...
 *                               compatible with com.dunnysoft.sidplay.sidplay
 *                             ---------------------------
 ...
 *
 */
package com.dunnysoft.sidplay.libsidplay.common.mos6510;

import static com.dunnysoft.sidplay.libsidplay.common.SIDEndian.endian_16hi8;
import static com.dunnysoft.sidplay.libsidplay.common.SIDEndian.endian_32hi16;
import static com.dunnysoft.sidplay.libsidplay.common.SIDEndian.endian_32lo16;
import static com.dunnysoft.sidplay.libsidplay.common.mos6510.IConf6510.NO_RTS_UPON_BRK;
...
public class SID6510 extends MOS6510 {
	...
	public SID6510(IEventContext context) {
		...
		//
		// The hacks for com.dunnysoft.sidplay.sidplay are done with overridden methods of MOS6510
		//
	...
	//
	// Ok start all the hacks for com.dunnysoft.sidplay.sidplay. This prevents
	...
	/**
	 * Hack for com.dunnysoft.sidplay.sidplay: Suppresses Illegal Instructions
	 */
	...
	/**
	 * Hack for com.dunnysoft.sidplay.sidplay: Stop jumps into ROM code
	 */
	...
	/**
	 * Hack for com.dunnysoft.sidplay.sidplay: No overlapping IRQs allowed
	 */
	...
	/**
	 * Hack for com.dunnysoft.sidplay.sidplay: Since no real IRQs, all RTIs mapped to RTS Required for
	...
	/**
	 * Hack for com.dunnysoft.sidplay.sidplay: Support of sidplays BRK functionality
	 */
	...
	/**
	 * Hack for com.dunnysoft.sidplay.sidplay: RTI behaves like RTI in sidplay1 modes
	 */
	...
	//
	// For com.dunnysoft.sidplay.sidplay compatibility implement those instructions which don't behave
	// properly.
	//
	...
	private void sid_jmp() {
		// For com.dunnysoft.sidplay.sidplay compatibility, inherited from environment
		if (m_mode == sid2_env_t.sid2_envR) {
